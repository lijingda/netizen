...
- **Sessions** 可按 Project、Scope、chat/topic 和 native 状态筛选，管理 active/inactive、
  Lazy/materialized/archived Binding，包括创建、切换、配置、重命名、归档、两种恢复、
  Lazy 删除、exact Stop 和 Release；
